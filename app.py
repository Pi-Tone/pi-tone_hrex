...
app = dash.Dash(
    __name__, meta_tags=[{"name": "viewport", "content": "width=device-width"}], routes_pathname_prefix='/dash-hrex-pct/'
)
app.title = "加拿大锦程-企业坞"
server = app.server
    ...
    [
        ...
        html.Div(
            [
                        ...
                        html.Div(
                            [
                                html.H3(
                                    ...
                                    style={"margin-top": "20px", "color":'#ffffff'},
                                ),
                                html.H5(
                                   "业务总览-Ontology", style={"margin-top": "0px", "color": "#ffffff"}, #font style需要修改
                                ),
                            ]
                        )
                    ],
                ...
                html.Div(
                    [
                        html.A(
                            html.Button("了解更多", id="learn-more-button", style={"color":"#ffffff"}),
                            href="https://www.pactown.ca",
                        )
                    ],
                    className="one-third column",
                    id="button",
            ...
            [
                html.Div(
                    [
                        ...
                        html.P("Filter by order status:", className="control_label"),
                        dcc.RadioItems(
                        ...
                        html.P("Filter by order type:", className="control_label"),
                        dcc.RadioItems(
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6(id="well_text"), html.P("订单数量")],  #订单数量wellnumbers
                                    id="wells",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="gasText"), html.P("未处理客服信息")],
                                    id="gas",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="oilText"), html.P("未收回账款")],
                                    id="oil",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="waterText"), html.P("年总盈利")],
                                    id="water",
                                    className="mini_container",
                                ),
                            ],
                        ...
                        html.Div(
                            [dcc.Graph(id="count_graph", config= {'displaylogo': False})], #删除图标plotly标签
        ...
        html.Div(
            [
                ...
                html.Div(
                    [dcc.Graph(id="individual_graph", config= {'displaylogo': False})],
        ...
        html.Div(
            [
                html.Div(
                    [dcc.Graph(id="pie_graph", config= {'displaylogo': False})],
                    className="pretty_container nine columns",
                ),
                html.Div(
                    [dcc.Graph(id="aggregate_graph", config= {'displaylogo': False})],
                    className="pretty_container five columns",
                ),
            ],
            className="row flex-display",
